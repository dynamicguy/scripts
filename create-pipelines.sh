...
}' http://localhost:8764/api/apollo/query-pipelines/products-simple
...
}' http://$1/api/apollo/query-pipelines/products-default

curl -X PUT -u admin:password123 -H 'Content-Type: application/json' -d '{
  "id": "products-default_copy",
  "stages": [
    {
      "type": "set-params",
      "id": "fclq5mi",
...
}' http://localhost:8764/api/apollo/query-pipelines/products-default_copy
